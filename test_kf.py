...
class TestKF(unittest.TestCase):
    ...
    def test_after_calling_predict_mean_and_cov_x_and_P_are_of_right_shape(self):
        x = 0.2
        v = 2.3
    ...
    def test_calling_predict_increases_state_uncertainty(self):
        ...
        for i in range(10):
            ...
            self.assertGreaterEqual(det_after, det_before)
            print(det_before, det_after)

    def test_after_calling_update_decreases_state_uncertainty(self):
        x = 0.2
        v = 2.3
